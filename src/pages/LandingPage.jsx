	...
	return (
		<div className='min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-orange-50'>
			...
			<div className='relative overflow-hidden'>
					...
					<div className='text-center'>
						<div className='flex justify-center mb-4 sm:mb-6'>
							<div className='relative'>
								...
								<ChefHat size={60} className='relative text-purple-600 sm:w-20 sm:h-20' />
							</div>
						</div>
						
						<h1 className='text-4xl sm:text-5xl md:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-purple-600 via-pink-600 to-orange-600 bg-clip-text text-transparent animate-fade-in px-4'>
							Recipe Finder
						</h1>
						...
						<div className='flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4'>
							<Link 
								to='/home' 
								className='btn btn-md sm:btn-lg bg-gradient-to-r from-purple-600 to-pink-600 text-white border-none hover:scale-105 active:scale-95 transition-transform duration-300 shadow-lg px-6 sm:px-8 w-full sm:w-auto touch-manipulation'
							>
							...
							<Link 
								to='/favorites' 
								className='btn btn-md sm:btn-lg btn-outline border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white active:scale-95 transition-all duration-300 px-6 sm:px-8 w-full sm:w-auto touch-manipulation'
							>
				...
				{/* Floating Recipe Cards Animation - Hidden on mobile */}
			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 pb-20 sm:pb-16'>
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8'>
					{/* Feature 1 */}
					<div className='bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] sm:hover:scale-105 transform active:scale-[0.98] touch-manipulation'>
						<div className='bg-gradient-to-br from-purple-100 to-pink-100 w-14 h-14 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center mb-4'>
							<Search className='text-purple-600' size={28} />
						</div>
						<h3 className='text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800'>Smart Search</h3>
					...
					{/* Feature 2 */}
					<div className='bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] sm:hover:scale-105 transform active:scale-[0.98] touch-manipulation'>
						<div className='bg-gradient-to-br from-pink-100 to-orange-100 w-14 h-14 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center mb-4'>
							<Heart className='text-pink-600' size={28} />
						</div>
						<h3 className='text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800'>Save Favorites</h3>
						<p className='text-sm sm:text-base text-gray-600'>
					...
					{/* Feature 3 */}
					<div className='bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] sm:hover:scale-105 transform active:scale-[0.98] touch-manipulation'>
						<div className='bg-gradient-to-br from-orange-100 to-yellow-100 w-14 h-14 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center mb-4'>
							<Utensils className='text-orange-600' size={28} />
						</div>
						<h3 className='text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-800'>Detailed Info</h3>
						<p className='text-sm sm:text-base text-gray-600'>
					...
					{/* Feature 4 */}
					<div className='bg-white rounded-2xl p-6 sm:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] sm:hover:scale-105 transform active:scale-[0.98] touch-manipulation'>
						<div className='bg-gradient-to-br from-green-100 to-teal-100 w-14 h-14 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center mb-4'>
